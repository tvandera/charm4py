...
if(Charm_FOUND AND NOT TARGET LibCharm::LibCharm)
  add_library(LibCharm::LibCharm UNKNOWN IMPORTED)
  set_target_properties(LibCharm::LibCharm PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${CHARM_INCLUDE_DIRS}")
  set_property(TARGET LibCharm::LibCharm APPEND PROPERTY IMPORTED_LOCATION "${CHARM_LIBRARY}")
endif()
